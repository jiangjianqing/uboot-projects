...
*/
/*4412 scp与上面的引脚不同*/
#define CLK_SRC_CPU_VAL	    (MUX_MPLL_SEL_FILPLL << 24) \
...
/* PLL_LOCK_TIME */
/*#define PLL_LOCKTIME		0x1C20*/	/*废弃不用*/
/*官方推荐的最大值 见P2798   Clock Timing Constants*/
...
#define APLL_CON1_VAL	((APLL_DCC_ENB << 21) | (APLL_AFC_ENB << 20) | (APLL_AFC << 0))	/*((APLL_AFC_ENB << 31) | (APLL_AFC << 0))*/

/* MPLL_CON0 */
#define MPLL_MDIV		175					/*0xC8*/
#define MPLL_PDIV		3					/*0x6*/
#define MPLL_SDIV		0					/*0x1*/
...
#define MPLL_CON1_VAL	((MPLL_DCC_ENB << 21) | (MPLL_AFC_ENB << 20) | (MPLL_AFC << 0))	/*((MPLL_AFC_ENB << 31) | (MPLL_AFC << 0))*/
